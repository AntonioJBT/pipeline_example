...
#PBS -e pass_picard.stderr
#PBS -o pass_picard.stdout
...
picard MarkDuplicates     INPUT=${BASE_DIR}/bwa.dir/SRR062634.bwa.bam     ASSUME_SORTED=true     METRICS_FILE=${BASE_DIR}/bwa.dir/SRR062634.bwa.picard_duplication_metrics     OUTPUT=/dev/null     VALIDATION_STRINGENCY=SILENT
